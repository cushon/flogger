...
public class StackWalkerStackGetterTest {
  ...
  private static final StackGetter STACK_WALKER_STACK_GETTER =
  ...
  public void testCallerOf() {
    assumeJava9OrAbove();
    StackGetterTestUtil.runTestCallerOf(STACK_WALKER_STACK_GETTER);
  }

  @Test
  public void testCallerOfBadOffset() {
    assumeJava9OrAbove();
    StackGetterTestUtil.runTestCallerOfBadOffset(STACK_WALKER_STACK_GETTER);
  }
